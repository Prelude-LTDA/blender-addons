"""
Shared UV Map node generation module.

Procedurally generates geometry node groups for UV mapping.
Supports Planar, Cylindrical, Spherical, Shrink Wrap, and Box (tri-planar) mapping.

This is the shared implementation that can be used by any addon.
The uv_map addon re-exports this and adds overlay/regeneration features.
"""
...
from ..node_group_compare import node_groups_match
