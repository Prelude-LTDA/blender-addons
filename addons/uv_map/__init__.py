...
_module_names: tuple[str, ...] = (
    ...
    "nodes",
    "operators",
    # Overlay subpackages (must be listed before overlay)
    "overlay.projection.plane",
    "overlay.projection.box",
    "overlay.projection.cylinder",
    "overlay.projection.sphere",
    "overlay.projection.shrink_wrap",
    "overlay.projection",
    "overlay.direction.inverse",
    "overlay.direction.utils",
    "overlay.direction.plane",
    "overlay.direction.box",
    "overlay.direction.cylinder",
    "overlay.direction.sphere",
    "overlay.direction.shrink_wrap",
    "overlay.direction",
    "overlay.handlers",
    "overlay",
    "menus",
